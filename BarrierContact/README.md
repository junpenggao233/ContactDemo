...
## About Newton Iteartion

For Incremental Potential Contact (barrier methods), it uses newton iteration with filtered line search, as you can check the details of this method here: https://phys-sim-book.github.io/lec3.2-line_search.html, which is guaranteed to be converged but it may need a lot of steps.
